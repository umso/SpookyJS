...
function provideAll(server) {
    server.provide(function execute(fn, args) {
        fn = createFunction(fn); // deserialize the passed function
        fn.call(instance); // call the deserialized function in the context of the Casper instance
    });
